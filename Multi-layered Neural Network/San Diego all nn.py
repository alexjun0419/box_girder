...
ColumnsData_12764 = pd.read_excel("~/Downloads/SoCal Data Science Program Team 3/SharedData/ColumnsData/ColumnsData_12764.xlsx")
ColumnsData_12955 = pd.read_excel("~/Downloads/SoCal Data Science Program Team 3/SharedData/ColumnsData/ColumnsData_12955.xlsx")


GMData_12764 = pd.read_excel("~/Downloads/SoCal Data Science Program Team 3/SharedData/GMData/GMData_12764.xlsx")
GMData_12955 = pd.read_excel("~/Downloads/SoCal Data Science Program Team 3/SharedData/GMData/GMData_12955.xlsx")
...
columns_12764 = clean_columns_data(ColumnsData_12764)
columns_12955 = clean_columns_data(ColumnsData_12955)



gm_12764 = clean_gm_data(GMData_12764)
gm_12955 = clean_gm_data(GMData_12955)
...
col_gm_12764 = join_and_select_columns(columns_12764, gm_12764)
col_gm_12955 = join_and_select_columns(columns_12955, gm_12955)
...
col_gm_12764_r = remove_out_of_range_di(col_gm_12764)
col_gm_12955_r = remove_out_of_range_di(col_gm_12955)

# Combine all san diego
col_gm_combined_sd = pd.concat([col_gm_12764_r, col_gm_12955_r], ignore_index=True)

# Ensure 'DI' is included in the selected variables
selected_vars = col_gm_combined_sd[['RP','DI','AI','Ke','M', 'Rx', 'Az', 'Dip', 'PGV', 'PGA', 'D575', 'CAV', 'HCol', 'PcFcAg', 'RR', 'DCol', 'DIrp', 'Sa', 'T1', 'DIesa', 'fcu', 'Dy']]
