...
selected_vars = col_gm_combined_la[['RP','Ke','AI','M', 'Rx', 'Az', 'Dip', 'DI', 'PGV', 'PGA', 'D575', 'CAV', 'HCol', 'PcFcAg', 'RR', 'DCol', 'DIrp', 'Sa', 'T1', 'DIesa', 'fcu', 'Dy']]

# Split the data into training and testing sets
train_data, test_data = train_test_split(selected_vars, test_size=0.2, random_state=123)

# Separate predictors and response
x_train = train_data[['RP','Ke','AI','M', 'Rx', 'Az', 'Dip', 'PGV', 'PGA', 'D575', 'CAV', 'HCol', 'PcFcAg', 'RR', 'DCol', 'DIrp', 'Sa', 'T1', 'DIesa', 'fcu', 'Dy']]
y_train = train_data['DI']
x_test = test_data[['RP','Ke','AI','M', 'Rx', 'Az', 'Dip', 'PGV', 'PGA', 'D575', 'CAV', 'HCol', 'PcFcAg', 'RR', 'DCol', 'DIrp', 'Sa', 'T1', 'DIesa', 'fcu', 'Dy']]
y_test = test_data['DI']
